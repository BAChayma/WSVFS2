...
@Path("/StructureAdrWS")
public class StructureAdrWS {
    
    public static final String TabAM = "model.AM.StructureadrAM";
    public static final String TabAM_CONFIG = "StructureadrAMLocal";
    
    @GET
    @Path("/LOVStructureAdr/")
    @Produces("application/json")
    @Consumes("application/json")
    public StructureAdr LOVStructureAdr () {
            String p_nb = null ;
            int p_kb = 0;
            StructureAdr list = new StructureAdr();
            ...
            try {
                ...
                list.setLibellesadr(p_nb);
                list.setKStructureAdr(p_kb);
            }
